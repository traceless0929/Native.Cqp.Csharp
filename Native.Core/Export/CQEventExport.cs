...
namespace Native.App.Export
{
	...
	{	
		...
		{	
			...
			Type appDataType = typeof (AppData);	
			// 注册一个 CQApi 实例	
			AppInfo appInfo = new AppInfo ("site.traceless.nativedemo", 1, 9, "��Q����Ӧ�� for C# Native", "1.0.0", 1, "Tracless", "��Q����Ӧ��(V9Ӧ�û���)", authCode);	
		...
		{	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IPrivateMessage> ("˽����Ϣ����"))	
			{	
				Event_eventPrivateMsgHandler += AppData.UnityContainer.Resolve<IPrivateMessage> ("˽����Ϣ����").PrivateMessage;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IGroupMessage> ("Ⱥ��Ϣ����"))	
			{	
				Event_eventGroupMsgHandler += AppData.UnityContainer.Resolve<IGroupMessage> ("Ⱥ��Ϣ����").GroupMessage;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IDiscussMessage> ("��������Ϣ����"))	
			{	
				Event_eventDiscussMsgHandler += AppData.UnityContainer.Resolve<IDiscussMessage> ("��������Ϣ����").DiscussMessage;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IGroupUpload> ("Ⱥ�ļ��ϴ��¼�����"))	
			{	
				Event_eventGroupUploadHandler += AppData.UnityContainer.Resolve<IGroupUpload> ("Ⱥ�ļ��ϴ��¼�����").GroupUpload;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IGroupManageChange> ("Ⱥ����䶯�¼�����"))	
			{	
				Event_eventSystem_GroupAdminHandler += AppData.UnityContainer.Resolve<IGroupManageChange> ("Ⱥ����䶯�¼�����").GroupManageChange;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IGroupMemberDecrease> ("Ⱥ��Ա�����¼�����"))	
			{	
				Event_eventSystem_GroupMemberDecreaseHandler += AppData.UnityContainer.Resolve<IGroupMemberDecrease> ("Ⱥ��Ա�����¼�����").GroupMemberDecrease;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IGroupMemberIncrease> ("Ⱥ��Ա�����¼�����"))	
			{	
				Event_eventSystem_GroupMemberIncreaseHandler += AppData.UnityContainer.Resolve<IGroupMemberIncrease> ("Ⱥ��Ա�����¼�����").GroupMemberIncrease;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IGroupBanSpeak> ("Ⱥ�����¼�����"))	
			{	
				Event_eventSystem_GroupBanHandler += AppData.UnityContainer.Resolve<IGroupBanSpeak> ("Ⱥ�����¼�����").GroupBanSpeak;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IFriendAdd> ("����������¼�����"))	
			{	
				Event_eventFriend_AddHandler += AppData.UnityContainer.Resolve<IFriendAdd> ("����������¼�����").FriendAdd;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IFriendAddRequest> ("�������������"))	
			{	
				Event_eventRequest_AddFriendHandler += AppData.UnityContainer.Resolve<IFriendAddRequest> ("�������������").FriendAddRequest;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IGroupAddRequest> ("Ⱥ���������"))	
			{	
				Event_eventRequest_AddGroupHandler += AppData.UnityContainer.Resolve<IGroupAddRequest> ("Ⱥ���������").GroupAddRequest;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<ICQStartup> ("��Q����¼�"))	
			{	
				Event_eventStartupHandler += AppData.UnityContainer.Resolve<ICQStartup> ("��Q����¼�").CQStartup;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<ICQExit> ("��Q�ر��¼�"))	
			{	
				Event_eventExitHandler += AppData.UnityContainer.Resolve<ICQExit> ("��Q�ر��¼�").CQExit;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IAppEnable> ("Ӧ���ѱ�����"))	
			{	
				Event_eventEnableHandler += AppData.UnityContainer.Resolve<IAppEnable> ("Ӧ���ѱ�����").AppEnable;	
			}	
			 ...
			 * Priority: 30000	
			 */	
			if (AppData.UnityContainer.IsRegistered<IAppDisable> ("Ӧ�ý���ͣ��"))	
			{	
				Event_eventDisableHandler += AppData.UnityContainer.Resolve<IAppDisable> ("Ӧ�ý���ͣ��").AppDisable;	
			}	
		...
		{	
			...
			{	
				CQPrivateMessageEventArgs args = new CQPrivateMessageEventArgs (AppData.CQApi, AppData.CQLog, 1, 21, "˽����Ϣ����", "_eventPrivateMsg", 30000, subType, msgId, fromQQ, msg.ToString(CQApi.DefaultEncoding), false);	
		...
		{	
			...
			{	
				CQGroupMessageEventArgs args = new CQGroupMessageEventArgs (AppData.CQApi, AppData.CQLog, 2, 2, "Ⱥ��Ϣ����", "_eventGroupMsg", 30000, subType, msgId, fromGroup, fromQQ, fromAnonymous, msg.ToString(CQApi.DefaultEncoding), false);	
		...
		{	
			...
			{	
				CQDiscussMessageEventArgs args = new CQDiscussMessageEventArgs (AppData.CQApi, AppData.CQLog, 3, 4, "��������Ϣ����", "_eventDiscussMsg", 30000, subType, msgId, fromNative, fromQQ, msg.ToString(CQApi.DefaultEncoding), false);	
		...
		{	
			...
			{	
				CQGroupUploadEventArgs args = new CQGroupUploadEventArgs (AppData.CQApi, AppData.CQLog, 4, 11, "Ⱥ�ļ��ϴ��¼�����", "_eventGroupUpload", 30000, subType, sendTime, fromGroup, fromQQ, file);	
		...
		{	
			...
			{	
				CQGroupManageChangeEventArgs args = new CQGroupManageChangeEventArgs (AppData.CQApi, AppData.CQLog, 5, 101, "Ⱥ����䶯�¼�����", "_eventSystem_GroupAdmin", 30000, subType, sendTime, fromGroup, beingOperateQQ);	
		...
		{	
			...
			{	
				CQGroupMemberDecreaseEventArgs args = new CQGroupMemberDecreaseEventArgs (AppData.CQApi, AppData.CQLog, 6, 102, "Ⱥ��Ա�����¼�����", "_eventSystem_GroupMemberDecrease", 30000, subType, sendTime, fromGroup, fromQQ, beingOperateQQ);	
		...
		{	
			...
			{	
				CQGroupMemberIncreaseEventArgs args = new CQGroupMemberIncreaseEventArgs (AppData.CQApi, AppData.CQLog, 7, 103, "Ⱥ��Ա�����¼�����", "_eventSystem_GroupMemberIncrease", 30000, subType, sendTime, fromGroup, fromQQ, beingOperateQQ);	
		...
		{	
			...
			{	
				CQGroupBanSpeakEventArgs args = new CQGroupBanSpeakEventArgs (AppData.CQApi, AppData.CQLog, 8, 104, "Ⱥ�����¼�����", "_eventSystem_GroupBan", 30000, subType, sendTime, fromGroup, fromQQ, beingOperateQQ, duration);	
		...
		{	
			...
			{	
				CQFriendAddEventArgs args = new CQFriendAddEventArgs (AppData.CQApi, AppData.CQLog, 10, 201, "����������¼�����", "_eventFriend_Add", 30000, subType, sendTime, fromQQ);	
		...
		{	
			...
			{	
				CQFriendAddRequestEventArgs args = new CQFriendAddRequestEventArgs (AppData.CQApi, AppData.CQLog, 11, 301, "�������������", "_eventRequest_AddFriend", 30000, subType, sendTime, fromQQ, msg.ToString (CQApi.DefaultEncoding), responseFlag);	
		...
		{	
			...
			{	
				CQGroupAddRequestEventArgs args = new CQGroupAddRequestEventArgs (AppData.CQApi, AppData.CQLog, 12, 302, "Ⱥ���������", "_eventRequest_AddGroup", 30000, subType, sendTime, fromGroup, fromQQ, msg.ToString (CQApi.DefaultEncoding), responseFlag);	
		...
		{	
			...
			{	
				CQStartupEventArgs args = new CQStartupEventArgs (AppData.CQApi, AppData.CQLog, 1001, 1001, "��Q����¼�", "_eventStartup", 30000);	
		...
		{	
			...
			{	
				CQExitEventArgs args = new CQExitEventArgs (AppData.CQApi, AppData.CQLog, 1002, 1002, "��Q�ر��¼�", "_eventExit", 30000);	
		...
		{	
			...
			{	
				CQAppEnableEventArgs args = new CQAppEnableEventArgs (AppData.CQApi, AppData.CQLog, 1003, 1003, "Ӧ���ѱ�����", "_eventEnable", 30000);	
		...
		{	
			...
			{	
				CQAppDisableEventArgs args = new CQAppDisableEventArgs (AppData.CQApi, AppData.CQLog, 1004, 1004, "Ӧ�ý���ͣ��", "_eventDisable", 30000);	
