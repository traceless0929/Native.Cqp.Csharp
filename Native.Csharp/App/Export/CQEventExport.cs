...
namespace Native.Csharp.App.Export
{
	...
	{	
		...
		{	
			...
			type.GetProperty ("Id", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { "site.traceless.smarttv2" });	
			...
			type.GetProperty ("Name", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { "剑三小T_V2" });	
			type.GetProperty ("Version", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { new Version ("1.0.1") });	
			...
			type.GetProperty ("Description", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { "这里是剑三小T V2全面重制版，使用NativeSDK,增加群管开关及群欢迎" });	
		...
		{	
			...
			Common.AppInfo.UnityContainer.RegisterInstance<CQApi> ("site.traceless.smarttv2", api);	
			// 向容器注册一个 CQLog 实例	
			log = new CQLog (authCode);	
			Common.AppInfo.UnityContainer.RegisterInstance<CQLog> ("site.traceless.smarttv2", log);	
